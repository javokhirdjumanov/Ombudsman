...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DomainLayer.Entities.DOC.InformationLetter", b =>
                {
                    ...
                    b.HasIndex("DocumentId")
                        .HasDatabaseName("ix_doc_information_letter_document_id");
            ...
            modelBuilder.Entity("DomainLayer.Entities.DOC.InformationLetter", b =>
                {
                    b.HasOne("DomainLayer.Entities.DOC.Document", "Document")
                        .WithMany()
                        .HasForeignKey("DocumentId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_doc_information_letter_doc_documents_document_id");

                    b.HasOne("DomainLayer.Entities.Employee", "Empoloyee")
                        .WithMany()
                        .HasForeignKey("EmployeeId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_doc_information_letter_hl_employee_employee_id");
