            ...
            modelBuilder.Entity("DomainLayer.Entities.ENUM.DocumentStatusTranslate", b =>
                {
                    ...
                    b.HasKey("Id")
                        .HasName("pk_document_status_translates");

                    b.HasIndex("DocumentStatusId")
                        .HasDatabaseName("ix_document_status_translates_document_status_id");

                    b.HasIndex("LanguageId")
                        .HasDatabaseName("ix_document_status_translates_language_id");

                    b.ToTable("document_status_translates", (string)null);
                });
            ...
            modelBuilder.Entity("DomainLayer.Entities.ENUM.InitiativeTypeTranslate", b =>
                {
                    ...
                    b.HasKey("Id")
                        .HasName("pk_initiative_type_translates");

                    b.HasIndex("InitiativeTypeId")
                        .HasDatabaseName("ix_initiative_type_translates_initiative_type_id");

                    b.HasIndex("LanguageId")
                        .HasDatabaseName("ix_initiative_type_translates_language_id");

                    b.ToTable("initiative_type_translates", (string)null);
                });
            ...
            modelBuilder.Entity("DomainLayer.Entities.ENUM.NormativeDocumentTypeTranslate", b =>
                {
                    ...
                    b.HasKey("Id")
                        .HasName("pk_normative_document_type_translates");

                    b.HasIndex("LanguageId")
                        .HasDatabaseName("ix_normative_document_type_translates_language_id");

                    b.HasIndex("NormativeDocumentTypeId")
                        .HasDatabaseName("ix_normative_document_type_translates_normative_document_type_");

                    b.ToTable("normative_document_type_translates", (string)null);
                });
            ...
            modelBuilder.Entity("DomainLayer.Entities.ENUM.PerformerTypeTranslate", b =>
                {
                    ...
                    b.HasKey("Id")
                        .HasName("pk_performer_type_translates");

                    b.HasIndex("LanguageId")
                        .HasDatabaseName("ix_performer_type_translates_language_id");

                    b.HasIndex("PerformerTypeId")
                        .HasDatabaseName("ix_performer_type_translates_performer_type_id");

                    b.ToTable("performer_type_translates", (string)null);
                });
            ...
            modelBuilder.Entity("DomainLayer.Entities.ENUM.StateOrganization", b =>
                {
                    ...
                    b.HasKey("Id")
                        .HasName("pk_enum_country_organization");

                    b.HasIndex("StatusId")
                        .HasDatabaseName("ix_enum_country_organization_status_id");

                    b.ToTable("enum_country_organization", (string)null);
                });
            ...
            modelBuilder.Entity("DomainLayer.Entities.ENUM.StateOrganizationTranslate", b =>
                {
                    ...
                    b.HasKey("Id")
                        .HasName("pk_state_organization_translates");

                    b.HasIndex("LanguageId")
                        .HasDatabaseName("ix_state_organization_translates_language_id");

                    b.HasIndex("StateOrganizationId")
                        .HasDatabaseName("ix_state_organization_translates_state_organization_id");

                    b.ToTable("state_organization_translates", (string)null);
                });
            ...
            modelBuilder.Entity("DomainLayer.Entities.ENUM.DocumentStatusTranslate", b =>
                {
                    b.HasOne("DomainLayer.Entities.ENUM.DocumentStatus", "DocumentStatus")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_document_status_translates_enum_document_status_document_st");
                    ...
                    b.HasOne("DomainLayer.Entities.ENUM.Language", "Languages")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_document_status_translates_enum_language_language_id");
            ...
            modelBuilder.Entity("DomainLayer.Entities.ENUM.InitiativeTypeTranslate", b =>
                {
                    b.HasOne("DomainLayer.Entities.ENUM.InitiativeType", "InitiativeType")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_initiative_type_translates_enum_initiative_type_initiative_");
                    ...
                    b.HasOne("DomainLayer.Entities.ENUM.Language", "Languages")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_initiative_type_translates_enum_language_language_id");
            ...
            modelBuilder.Entity("DomainLayer.Entities.ENUM.NormativeDocumentTypeTranslate", b =>
                {
                    b.HasOne("DomainLayer.Entities.ENUM.Language", "Languages")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_normative_document_type_translates_enum_language_language_id");
                    ...
                    b.HasOne("DomainLayer.Entities.ENUM.NormativeDocumentType", "NormativeDocumentType")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_normative_document_type_translates_enum_normative_document_");
            ...
            modelBuilder.Entity("DomainLayer.Entities.ENUM.PerformerTypeTranslate", b =>
                {
                    b.HasOne("DomainLayer.Entities.ENUM.Language", "Languages")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_performer_type_translates_enum_language_language_id");
                    ...
                    b.HasOne("DomainLayer.Entities.ENUM.PerformerType", "PerformerType")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_performer_type_translates_enum_performer_type_performer_typ");
            ...
            modelBuilder.Entity("DomainLayer.Entities.ENUM.StateOrganization", b =>
                {
                    b.HasOne("DomainLayer.Entities.ENUM.Status", "Status")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_enum_country_organization_enum_status_status_id");
            ...
            modelBuilder.Entity("DomainLayer.Entities.ENUM.StateOrganizationTranslate", b =>
                {
                    b.HasOne("DomainLayer.Entities.ENUM.Language", "Languages")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_state_organization_translates_enum_language_language_id");
                    ...
                    b.HasOne("DomainLayer.Entities.ENUM.StateOrganization", "StateOrganization")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_state_organization_translates_enum_country_organization_sta");
            ...
            modelBuilder.Entity("DomainLayer.Entities.INFO.Organization", b =>
                {
                    ...
                    b.HasOne("DomainLayer.Entities.ENUM.StateOrganization", "StateOrganization")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_info_organization_enum_country_organization_state_organizat");
